function [region_state] = init_neural_state(psth_struct, event_ts, trial_range)
    ...
    col_names = {'trial_number', 'event_label', 'event_ts', 'state'};
    region_state = struct;
    for region_index = 1:length(unique_regions)
        ...
        region_state.(region) = region_table;
    end
end
function [first_latency, last_latency, duration, peak_latency, peak, corrected_peak, ...
        ...
        post_response, smoothed_threshold, bin_size, post_start, span)
    ...
    smoothed_post_window = smooth(post_response, span);
    above_threshold_indeces = find(smoothed_post_window > smoothed_threshold);
    above_threshold = smoothed_post_window(above_threshold_indeces);
    first_latency = above_threshold_indeces(1);
    last_latency = above_threshold_indeces(end);

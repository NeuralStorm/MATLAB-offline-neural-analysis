    ...
    for dir_i = 1:length(dir_list)
        ...
        try
            ...
            batch_extract_spikes(dir_save_path, dir_failed_path, ...
                data_dir_path, curr_dir, dir_config, label_table);
        catch ME

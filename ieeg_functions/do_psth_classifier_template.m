function [pop_table, chan_table, classify_res] = do_psth_classifier_template(rr_data, ...
    ...
    pop_headers = [["chan_group", "string"]; ["tot_trials", "double"]; ...
                   ["tot_selected_trials", "double"]; ["tot_chans", "double"]; ...
    ...
    chan_headers = [["chan_group", "string"]; ["channel", "string"]; ...
                    ["tot_trials", "double"]; ["tot_selected_trials", "double"]; ...
                    ["performance", "double"]; ["mutual_info", "double"]];
    ...
    tot_selected_trials = height(event_info(logical(event_info.include_trials), :));

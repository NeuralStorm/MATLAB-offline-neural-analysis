function [] = batch_power_mnts_to_psth(save_path, failed_path, data_path, ...
    ...
    for file_index = 1:length(file_list)
        ...
        try
            ...
            load(file, 'component_results', 'event_info', ...
            ...
            % Not saving baseline and response structs to save on space
            psth_struct = power_reformat_mnts(pc_log, component_results, tot_bins);

            matfile = fullfile(save_path, [filename_substring_one, ...
                '_format_' filename_meta.filename, '.mat']);
            save(matfile, '-v7.3', 'psth_struct', 'event_info', ...

function [] = batch_reshape_to_mnts(save_path, failed_path, data_path, ...
    ...
    if iscell(dir_config.filter_val)
        dir_config.filter_val = cell2mat(dir_config.filter_val);
    end
    ...
    for file_index = 1:length(file_list)
        ...
        try
            ...
            load(file, 'power_struct', 'filename_meta', 'trial_meta');
            ...
            [chan_group_log, mnts_struct, event_info, band_shifts] = reshape_to_mnts(session_labels, power_struct, ...
                trial_meta, dir_config.select_features, dir_config.include_events, dir_config.use_z_mnts, ...
                ...
                dir_config.trial_filter, dir_config.filter_val);

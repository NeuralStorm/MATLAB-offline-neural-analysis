function [] = batch_reshape_to_mnts(save_path, failed_path, data_path, ...
    ...
    for file_index = 1:length(file_list)
        ...
        try
            ...
            [label_log, mnts_struct, event_info] = reshape_to_mnts(session_labels, power_struct, ...
                dir_config.select_features, dir_config.selected_events, dir_config.use_z_mnts, ...
                dir_config.smooth_power, dir_config.span, ...
                dir_config.downsample_pow, dir_config.downsample_rate, ...
                dir_config.slice_time, bin_size, ...
            ...
            save(matfile, '-v7.3', 'mnts_struct', 'label_log', 'event_info', ...

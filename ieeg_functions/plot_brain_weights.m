function [] = plot_brain_weights(save_path, mesh_struct, elec_struct, component_results, ...
    ...
    parfor space_i = 1:numel(unique_spaces)
        ...
        if size(component_results.(curr_space).coeff, 1) < min_components
            continue
        end
        ...
        %TODO generalize across principal components
        coeff = component_results.(curr_space).coeff(:, 1);
        ...
        elec_weights = rescale(abs(coeff), 1, 250);

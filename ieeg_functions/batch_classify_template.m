function [] = batch_classify_template(project_path, save_path, failed_path, data_path, dir_name, filename_substring_one, config)
    ...
    for file_index = 1:length(file_list)
        ...
        try
            ...
            %% Classify
            [pop_table, chan_table, classify_res] = do_psth_classifier_template(...

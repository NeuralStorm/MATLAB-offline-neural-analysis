...
text(handles.axes1, window(1) + 0.02, max_point - 3, ['pos peak latency: ' num2str(pos_peak_latency/1000) 's, pos peak value: ' num2str(pos_peak) 'mV']);
text(handles.axes1, window(1) + 0.02, min_point + 3, ['neg peak latency: ' num2str(neg_peak_latency/1000) 's, neg peak value: ' num2str(neg_peak) 'mV']);

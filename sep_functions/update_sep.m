function [] = update_sep(sep_path, ignore_sessions, trial_range)
    ...
    for file_index = 1:length(file_list)
        ...
        load(file, 'sep_struct', 'sep_l2h_map', 'config_log');
        empty_vars = check_variables(file, sep_struct, sep_l2h_map);
        if empty_vars
            continue
        end
        config_log.trial_range = trial_range;
        config_log.ignore_sessions = ignore_sessions;
        ...
        save(file, '-append', 'sep_l2h_map', 'sep_struct', 'config_log');

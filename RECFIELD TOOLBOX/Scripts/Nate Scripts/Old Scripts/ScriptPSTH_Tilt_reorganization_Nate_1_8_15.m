...
filename='Ravi015.Baseline.HLONLY.123014';
...
options.region={1:32};%%1:32; this means number of channels
options.regionname={'CTX'};
options.binsizean=[1 2 20 50]/1000;%set binsizes for analysis  doesn't like not having 1
...
options.evchannels=[1:6];    %these are the event channels for each tilt type 
%% Tilt Discrimination

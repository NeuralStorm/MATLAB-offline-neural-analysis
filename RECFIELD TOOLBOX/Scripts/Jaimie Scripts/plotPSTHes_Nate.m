...
TIMElength=1000;%1000 for 1 ms %280  %makethis the number of bins
% close all;
% temp1=PeriEventMatrixAll(1:100,:);  %trial 1 values
% temp2=PeriEventMatrixAll(101:201,:);
% temp3=PeriEventMatrixAll(202:301,:);
% temp4=PeriEventMatrixAll(302:400,:);
...
%     tempy4(i,:)=meanPeri4(stpt:endpt);
    ...
    Sneurons5(i,:)=smooth(neurons5(i,:),nn);
    Sneurons6(i,:)=smooth(neurons6(i,:),nn);
    Sneurons7(i,:)=smooth(neurons7(i,:),nn);
    Sneurons8(i,:)=smooth(neurons8(i,:),nn);
